    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#4886ff", "#0e9e4a", "#fa7d03", "#ff484c"],
                responsive: [{
                    breakpoint: 480,
                    options: {
                        legend: {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#4886ff", "#00acc1", "#0e9e4a", "#fa7d03", "#ff484c"],
                stroke: {
                    width: 1,
                    colors: ['#fff']
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ["#4886ff", "#0e9e4a", "#ff484c", "#fa7d03", "#00acc1"],
                series: [{
                    name: "SAMPLE A",
                    data: [
                        [16.4, 5.4],
        ...
        $(function() {
            var options = {
                ...
                colors: ["#4886ff", "#0e9e4a", "#00acc1", "#fa7d03", "#ff484c"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
