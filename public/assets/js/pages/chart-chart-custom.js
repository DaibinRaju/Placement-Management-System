...
$(document).ready(function() {
    ...
    var data1 = {
        ...
        datasets: [{
            ...
            hoverborderColor:'#4886ff',
            hoverBackgroundColor: '#4886ff',
        }, {
            label: "Data 2",
            data: [30, 52, 65, 65],
            borderColor: '#0e9e4a',
    ...
    var data1 = {
        ...
        datasets: [{
            ...
            hoverborderColor:'#fa7d03',
            hoverBackgroundColor: '#fa7d03',
        }]
    };
    var myBarChart = new Chart(bar, {
        type: 'bar',
    ...
    var data1 = {
        ...
        datasets: [{
            ...
            hoverborderColor:'#ff484c',
            hoverBackgroundColor: '#ff484c',
        }]
    };
    var myBarChart = new Chart(bar, {
        type: 'horizontalBar',
    ...
    var data1 = {
        ...
        datasets: [{
            ...
            borderWidth: 4,
            borderColor: '#7ad835',
            backgroundColor: '#7ad835',
            hoverborderColor: '#7ad835',
            hoverBackgroundColor: '#7ad835',
        }]
    };
    var myBarChart = new Chart(bar, {
        type: 'line',
