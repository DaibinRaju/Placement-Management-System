				...
				<div class="card-body p-b-0">
					...
					<div class="col-md-12 col-sm-12">
                            <div class="float-right d-xl-inline-block d-lg-inline-block">
                            	<a href="/admin/drive/edit/{{$drive->id}}" class="float-right btn waves-effect waves-light btn-rounded btn-primary">Edit Drive</a>
                            </div>
                        </div>
						<!-- <span class="badge badge-success float-right">ACTIVE</span> -->
						<div class="row">
						<div class="float-right d-xl-inline-block d-lg-inline-block">
                    		<a href="/admin/drive/" class="float-right btn waves-effect waves-light btn-rounded btn-primary">Go Back</a>
                		</div>
			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table class="table color-table primary-table">
						...
						<tbody>
							@foreach($files as $errors)
							<tr>
								<td class="font-bold">{{ $errors['filename'] }}</td>
								<td>{{ $errors['uploaded_by'] }}</td>
								<td>{{ $errors['upload_date'] }}</td>
								<td>{{ $errors['filesize'] }}</td>
								<td>
									<form method="post" action="/admin/fileaction">
										...
										<input type="hidden" id="cat2" name="fileid" value="{{ $errors['id'] }}">
								...
								<td>
									<form method="post" action="/admin/fileaction">
										...
										<input type="hidden" id="cat4" name="fileid" value="{{ $errors['id'] }}">
