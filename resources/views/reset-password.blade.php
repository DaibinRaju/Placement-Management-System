                ...
                <div class="row align-items-center ">
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-block btn-primary mb-4 rounded-pill">Reset password</button>
                            <p class="mb-0 text-muted">Go to login <a href="login" class="f-w-400">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
