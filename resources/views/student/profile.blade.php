...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-md-6 f-14 font-weight-bold m-b-20"><span class="fa fa-circle text-danger circle-tab mr-3"></span> April 2014 -
                        November 2016</div>
                    ...
                    <div class="col-lg-4 col-md-6 font-weight-bold m-b-20">London School of Economics
                        and Political Science</div>
                </div>
